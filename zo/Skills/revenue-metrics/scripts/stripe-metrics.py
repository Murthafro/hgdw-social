...
Store your Stripe API key at /home/workspace/.config/stripe/api_key
or in Zo Settings > Advanced.
"""

import json, os, subprocess, sys, urllib.request, base64, ssl
...
# --- CONFIGURE THESE ---
stripe_key_path = "/home/workspace/.config/stripe/api_key"
...
def fetch_charges(acct_id, since, until):
    ...
    auth_b64 = base64.b64encode(f"{stripe_key}:".encode('ascii')).decode('ascii')
    
    while url:
        req = urllib.request.Request(url)
        req.add_header('Authorization', f'Basic {auth_b64}')
        req.add_header('Stripe-Account', acct_id)
